<div id="gauche">
    ...
    if (isset($_SESSION['user']['role']) && $_SESSION['user']['role'] === 'role_responsable') {
        ...
        echo "<a class='nav-link' href='../View/V-Affiche-CR-Region-Resp.php'><i class='fa-regular fa-file' style='color: #C56752;'></i>Comptes rendus par régions</a>";
        echo "</li>";
        echo "<li class='nav-item'>";
        echo "<a class='nav-link' href='../View/V-Statistiques.php'><i class='fa-solid fa-chart-column' style='color: #c56752;'></i>Statistiques</a>";
        echo "</li>";
        echo "<li class='nav-item'>";
