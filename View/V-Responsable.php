...
<section>
    <div id="gauche">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class='nav-link' href='#'>Echantillons</a>
            </li>
            <li class="nav-item">
                <a class='nav-link' href='V-Affiche-Modif-User.php'>Modification des Utilisateurs</a>
            </li>
            <li class="nav-item">
                <a class='nav-link' href='V-Inscription.php'>Créer des utilisateurs</a>
            </li>
        </ul>
